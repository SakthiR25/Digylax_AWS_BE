...
// // // Middleware
// // app.use(cors({
// //     origin: 'https://digylax-ocr-backend.onrender.com',
...
//         const allowedOrigins = ['https://sakthivelocr.netlify.app', 'http://localhost:3000'];
...
// // Use routes
// app.use('/api', invoiceLayout); // Prefix all invoice routes with /api


// /////Layout routes

// app.use('/Layout', Layout); // Prefix all invoice routes with /api

// /////Tabdata

// app.use('/Tabledata', Tabdata); // Prefix all invoice routes with /api

// /////sappointegration
// app.use('/sappo', sappointegration); // Prefix all invoice routes with /api

// /////Base64

// app.use('/base64', Base664file); // Prefix all invoice routes with /api

// /////Authentication 
// app.use('/Auth', Authentication); // Prefix all invoice routes with /api
...
// Middleware
app.use(cors({
    origin: ['http://localhost:3001', 'http://digylaxautomation.s3-website-ap-southeast-2.amazonaws.com'], // Include your Netlify frontend URL
    methods: 'GET,HEAD,PUT,PATCH,POST,DELETE',
    credentials: true,
    optionsSuccessStatus: 204,
    allowedHeaders: 'Content-Type,Authorization',
...
// Layout routes
app.use('/Layout', Layout); // Prefix all layout routes with /Layout

// Tabdata routes
app.use('/Tabledata', Tabdata); // Prefix all tab data routes with /Tabledata

// SAP PO integration routes
app.use('/sappo', sappointegration); // Prefix all SAP PO routes with /sappo

// Base64 routes
app.use('/base64', Base664file); // Prefix all base64 routes with /base64

// Authentication routes
app.use('/Auth', Authentication); // Prefix all authentication routes with /Auth
